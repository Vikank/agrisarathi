      ...
      body: Column(
        children: [
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(top: 16.0, bottom: 16, left: 24, right: 45),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        CachedNetworkImage(
                          imageUrl:
                          "${ApiEndPoints.baseUrl}${farmerLands![index].cropImages?.first ??
                              ""}",
                          imageBuilder:
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 5,),
                              Text(
                                '${farmerLands![index].address ?? ""},${farmerLands![index].village ?? ""},${farmerLands![index].district ?? ""},${farmerLands![index].state ?? ""}',
                                style: const TextStyle(
                                    fontSize: 12,
          ...
          Padding(
            ...
            child: CustomElevatedButton(buttonColor: Color(0xff00B251), onPress: (){
              Get.to(()=> AddFarmLand());
