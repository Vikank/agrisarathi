      ...
      body: Obx(() {
        return Column(
          ...
          children: [
                    ...
                    return Stack(
                      children: <Widget>[
                        Container(
                          ...
                          child: Image.network('http://64.227.166.238:8090/media/' + crop.cropImage, fit: BoxFit.fill,),
                        ),
                        Positioned(
                          top: 0,
                          right: 0,
              ...
              child: Wrap(
                ...
                children: [
                  FilterChip(
                    ...
                    label: Text('Cereals', style: TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 13,
                        color: Colors.black),),
                    selected: controller.selectedCategory.value == 'CerealField',
                    selectedColor: Colors.green,
                    onSelected: (isSelected) => controller.filterCrops(isSelected ? 'CerealField' : ''),
                  ),
                  FilterChip(
                    showCheckmark: false,
                    shape: RoundedRectangleBorder(
                    ...
                    label: Text('Pulse', style: TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 13,
                        color: Colors.black),),
                    selected: controller.selectedCategory.value == 'Pulse',
                    selectedColor: Colors.green,
                    onSelected: (isSelected) => controller.filterCrops(isSelected ? 'Pulse' : ''),
                  ),
                  FilterChip(
                    showCheckmark: false,
                    shape: RoundedRectangleBorder(
                    ...
                    label: Text('Fruit', style: TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 13,
                        color: Colors.black),),
                    selected: controller.selectedCategory.value == 'Fruit',
                    selectedColor: Colors.green,
                    onSelected: (isSelected) => controller.filterCrops(isSelected ? 'Fruit' : ''),
                  ),
                  FilterChip(
                    showCheckmark: false,
                    shape: RoundedRectangleBorder(
                    ...
                    label: Text('Vegetable', style: TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 13,
                        color: Colors.black),),
                    selected: controller.selectedCategory.value == 'Vegetable',
                    selectedColor: Colors.green,
                    onSelected: (isSelected) => controller.filterCrops(isSelected ? 'Vegetable' : ''),
                  ),
                ],
              ),
            ),
            ...
            Expanded(
              child:
                  controller.displayedCrops.isEmpty
                    ? Center(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Image.network(
                                      "http://64.227.d166.238:8090/media/${crop.cropImage}", fit: BoxFit.contain),
                                ),
                              ),
                              Text(crop.cropName, overflow: TextOverflow.ellipsis,)
                            ],
                          );
                        },
                      ),
