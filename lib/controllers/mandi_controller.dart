...
class MandiController extends GetxController{
  ...
  Future<void> getDukanFilterProduct() async {
    var response = await http
        .get(Uri.parse('http://64.227.166.238:8090/getproduct_category'));
    if (response.statusCode == 200) {
      var data = json.decode(response.body);
  ...
  Future<void> getCityFilter() async {
    var response = await http
        .get(Uri.parse('http://64.227.166.238:8090/getallcity'));
    if (response.statusCode == 200) {
      var data = json.decode(response.body);
  ...
  Future<void> getStateFilter() async {
    var response = await http
        .get(Uri.parse('http://64.227.166.238:8090/getshops_states'));
    if (response.statusCode == 200) {
      var data = json.decode(response.body);
